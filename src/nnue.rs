...
// Default (no feature) = net-0183 (flywheel v3: architecture identical to
// 0063 -- HIDDEN=128, 8 output buckets -- but the training corpus was
// generated by the 0.7.0 engine itself instead of the older 0085-era stack.
// probe 0183 GREEN +88.3 Elo on the production time control, 2500 games;
// externally +54.1 -> 2917 CCRL in probe 0193). Promoted default-on in 0.8.0.
// Rollback / ablation to net-0063: cargo feature `nnue_0063`.
// Features nnue_h512/nnue_h1024 are A/B binaries.
#[cfg(all(not(feature = "nnue_h512"), not(feature = "nnue_h1024"), not(feature = "nnue_aug0041"), not(feature = "nnue_kbuckets"), not(feature = "nnue_l2"), not(feature = "nnue_i8"), not(feature = "nnue_0063")))]
pub const HIDDEN: usize = 128;
#[cfg(all(not(feature = "nnue_h512"), not(feature = "nnue_h1024"), not(feature = "nnue_aug0041"), not(feature = "nnue_kbuckets"), not(feature = "nnue_l2"), not(feature = "nnue_i8"), not(feature = "nnue_0063")))]
const RAW: &[u8] = include_bytes!("nets/neryba0183.bin");

// net-0063 -- the previous production net (0.5.0-0.7.0), now an ablation
// feature. Same architecture (HIDDEN=128, 8 output buckets); the only
// difference is the corpus the weights were trained on.
#[cfg(feature = "nnue_0063")]
pub const HIDDEN: usize = 128;
#[cfg(feature = "nnue_0063")]
